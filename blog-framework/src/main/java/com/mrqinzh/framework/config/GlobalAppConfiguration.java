...
public class GlobalAppConfiguration {
    ...
    public ObjectMapper jacksonObjectMapper(Jackson2ObjectMapperBuilder builder) {
        ...
        module.addSerializer(Date.class, new DateSerializer(false, new SimpleDateFormat(DateUtil.YYYY_MM_DD_HH_MM_SS)));
        module.addDeserializer(Date.class, new DateDeserializers.DateDeserializer(new DateDeserializers.DateDeserializer(),
                new SimpleDateFormat(DateUtil.YYYY_MM_DD_HH_MM_SS), DateUtil.YYYY_MM_DD_HH_MM_SS));
