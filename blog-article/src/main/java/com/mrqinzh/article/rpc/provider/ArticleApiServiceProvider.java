...
import com.mrqinzh.apis.article.ArticleApiService;
...
@DubboService
public class ArticleApiServiceProvider implements ArticleApiService {

    private static final Logger logger = LoggerFactory.getLogger(ArticleApiServiceProvider.class);
